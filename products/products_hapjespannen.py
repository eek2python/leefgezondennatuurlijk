...
"woll_ecolite_qxr_24": {
    ...
    "bk_easy_induction_24": {
        ...
        "image_path": "images/hapjespannen",
        "pros": [
            "Ruime inhoud voor dagelijkse maaltijden",
            "Glazen deksel geschikt voor sudderen",
            "Complete set voor een toegankelijke prijs",
        ],
        "cons": [
            "Niet ovenbestendig",
            "Antiaanbakeigenschappen kunnen bij intensief gebruik sneller afnemen",
        ],
        "verdict": "Een toegankelijke hapjespan voor dagelijkse maaltijden en éénpansgerechten",
    },
...
"greenpan_cambridge_24": {
   ...
   "image_path": "images/hapjespannen",
   "pros": [
       "Betrouwbare warmteverdeling",
       "Licht en prettig in dagelijks gebruik",
       "Geschikt voor dagelijkse bereidingen",
   ],
   "cons": [
       "Minder robuust dan premium modellen",
       "Niet bedoeld voor extreem hoge temperaturen",
   ],
    "verdict": "Een praktische en toegankelijke hapjespan voor regelmatig dagelijks gebruik.",
},
