CONTENT = {
    ...
    "size_guide": None,
    "products_section": {
        "h2": "De {product_count} beste hapjespannen van 2026 \u2013 {selected_size}\u00a0cm",
        "comparison_title": "Vergelijkingstabel \u2013 Top {product_count} PFAS-vrije Hapjespannen ({selected_size}\u00a0cm)",
    },
    "tips": {
        "title": "Onderhoudstips voor PFAS-vrije hapjespannen",
        "intro": (
            "Met de juiste verzorging gaan PFAS-vrije hapjespannen jarenlang mee. "
            "Volg de onderstaande tips voor het beste behoud van de antiaanbaklaag en optimale kookprestaties."
        ),
        "bullets": [
            "<strong>Reinig met de hand:</strong> was de pan altijd af met warm water en een zachte spons. Vermijd agressieve schuursponzen of staalwol.",
            "<strong>Gebruik milde zeep:</strong> sterke ontvetters kunnen de keramische laag aantasten.",
            "<strong>Laat de pan goed afkoelen:</strong> zet een hete pan nooit onder koud water om thermische schok en vervorming te voorkomen.",
            "<strong>Gebruik houten of siliconen keukengerei:</strong> metalen spatels kunnen de coating beschadigen.",
    ...
    "faq": {
        "title": "Veelgestelde vragen over PFAS-vrije hapjespannen",
        "items": [
            {
            ...
            {
                "q": "Kan een PFAS-vrije hapjespan op inductie gebruikt worden?",
                "a": (
                    "Ja, alle pannen in onze top\u00a010 zijn geschikt voor inductie. "
                    "Zorg wel voor goed contact tussen de panbodem en de kookplaat voor optimale warmtegeleiding."
                ),
            },
            {
                "q": "Wat is het beste formaat hapjespan?",
                "a": (
                    "Het meest veelzijdige formaat is 28\u00a0cm. Dit biedt voldoende ruimte voor \u00e9\u00e9npansgerechten, sauzen, vlees, vis, groenten en roerbakgerechten. "
