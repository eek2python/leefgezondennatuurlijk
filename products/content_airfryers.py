CONTENT = {
    ...
    "why_choose": {
        ...
        "intro": (
            ...
            "of dampen kunnen afgeven. Een PFAS-vrije airfryer voorkomt deze risico\u2019s en biedt een veilige, duurzame oplossing voor dagelijks gebruik."
        ),
        "bullets": [
    ...
    "size_guide": None,
    "products_section": {
        "h2": "De 6 beste PFAS-vrije airfryers van 2026",
        "intro": None,
        "comparison_title": "Vergelijkingstabel \u2013 Top 6 PFAS-vrije Airfryers",
    },
    "tips": {
        ...
        "bullets": [
            ...
            "Gebruik geen metalen spatels of schuurmateriaal om de keramische laag te beschermen.",
            "Laat de mand volledig drogen voordat je deze terugplaatst.",
            "Vermijd sprays met olie onder hoge druk: gebruik liever een bakkwast of een plantaardige olie met hoge rooktemperatuur.",
            "Ontkoppel de airfryer na gebruik en laat deze afkoelen voor reiniging.",
        ],
        "outro": None,
    },
    "conclusies": {
        "default": {
            ...
            "text": (
                "Wie op zoek is naar een veilige, duurzame en volledig PFAS-vrije airfryer heeft vandaag uitstekende keuzes. "
                "De <strong>Inventum GF500HLD</strong> biedt de beste balans tussen prestaties, duurzaamheid en gebruiksgemak. "
                "Voor een budgetvriendelijke maar betrouwbare optie is de <strong>Bourgini Slimfit XL</strong> een uitstekende keuze. "
                "De premium <strong>GreenPan Silhouette Airfryer XL</strong> blinkt uit in veelzijdigheid en bouwkwaliteit. "
                "Dankzij de moderne keramische coatings in alle zes de modellen kun je in alle gevallen rekenen op gezond en veilig koken zonder schadelijke stoffen."
            ),
        },
    },
    "faq": {
        ...
        "items": [
            {
                ...
                "a": "Nee. Veel traditionele anti-aanbaklagen bevatten PFAS. Kies daarom specifiek voor een PFAS-vrije keramische coating.",
            },
            {
                "q": "Is keramisch altijd PFAS-vrij?",
                "a": "Ja. Keramische coatings op silica-basis bevatten geen PFAS en zijn veilig bij hoge temperaturen.",
            },
            {
                "q": "Welke airfryer is het meest duurzaam?",
                "a": "Modellen met keramische coatings hebben doorgaans een langere levensduur en behouden hun anti-aanbakprestaties beter.",
            },
            {
