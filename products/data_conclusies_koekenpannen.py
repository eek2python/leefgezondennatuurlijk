CONCLUSIES_BY_SIZE = {
   ...
   24: {
       ...
       "text": (
           ...
           "optie zoekt, is de <strong>Kochstar Essenz</strong>, een loische budgetkeuze die goed "
    ...
    26: {
       "title": "Conclusie – Onze aanbeveling",
       "text": (
        "Het formaat <strong>26 cm</strong> is een veelzijdige maat voor wie nét wat meer ruimte wil dan standaard, zonder direct naar een grote pan te "
...
32: {
       ...
       "text": (
               "Een <strong> 32 cm koekenpan </strong> is bij uitstek geschikt voor grote "
                ...
                "restaties, ook bij intensief gebruik.Zoek je maximale controle en een "
                ...
                "kiest, met een expliciet PFAS-vrije 32 cm koekenan kook je efficiënt, "
